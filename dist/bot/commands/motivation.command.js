...
import { createSuccessEmbed, createInfoEmbed, createErrorEmbed, } from '../../utils/embed-builder.js';
import { safeDeferReply } from '../../utils/interaction.utils.js';
import { postHourlyMotivation, MOTIVATION_QUOTES, } from '../jobs/hourly-motivation.job.js';
        ...
        if (sub === 'post') {
            ...
            if (res.success && res.quote) {
                await interaction.editReply({
                    embeds: [
                        createSuccessEmbed('Discipline Broadcast Sent! 🗿', `Successfully broadcasted quote to <#${res.channelId}>!\n\n` +
                ...
                await interaction.editReply({
                    embeds: [
                        createErrorEmbed('Broadcast Failed', res.error || 'Could not send discipline quote to the channel.'),
                    ],
                });
            }
        }
            ...
            await interaction.editReply({
                embeds: [
                    createInfoEmbed('⚙️ Hourly Motivation Worker Status', `• **Interval:** Every hour on the hour (\`0 * * * *\`)\n` +
            ...
            await interaction.editReply({
                embeds: [
                    createInfoEmbed(`👀 Next Quote Preview (#${nextIndex + 1}/${MOTIVATION_QUOTES.length})`, `> *"“${quote.quote}”"*\n\n` +
...
//# sourceMappingURL=motivation.command.js.map