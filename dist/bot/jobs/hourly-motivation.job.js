 ...
 */
export async function postHourlyMotivation(client, forceChannelId) {
    if (!client.isReady()) {
    ...
    try {
        ...
        logger.info({ channelId: targetChannel.id, quoteIndex: nextIndex, author: selectedQuote.author }, '📢 Hourly motivation broadcast successfully sent');
        return {
            success: true,
 ...
 */
export function initHourlyMotivationJob(client) {
...
//# sourceMappingURL=hourly-motivation.job.js.map